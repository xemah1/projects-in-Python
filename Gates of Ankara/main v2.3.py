        ...
        for i in range(len(grid)) :
            if grid[i] == 0 :
                ...
                if placeholder == 2304 :
                    ...
                    grid[i] = 1002
                elif 1440 < placeholder and placeholder <= 1450 :
                    grid[i] = 7
                elif 2240 < placeholder and placeholder <= 2250 :
                    grid[i] = 7
                elif 620 < placeholder and placeholder <= 630 :
                    grid[i] = 7
...
if bonus_choice == "Y" or bonus_choice == "y" :
    print("Bonus Game Result:",banka_kazanc)
    print("----------------------------------")
